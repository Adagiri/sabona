...
export default class VendorController {
    ...
    async addLaundry(
        ...
        @CurrentUser() user: User): Promise<CreateLaundryReponseDTO> {
    ...
    async getLaundryById(
        ...
        @CurrentUser() user: User): Promise<GetLaundryByIdResponseDTO> {
        return await this._vendorService.getLaundryById(laundryId, user)
    }
    ...
    async editLaundry(
        ...
        @CurrentUser() user: User): Promise<LaundryMessageResponseDTO> {
    ...
    async editLaundryService(
        ...
        @CurrentUser() user: User): Promise<LaundryServiceMessageResponseDTO> {
    ...
    async getAllLaundryServiceItems(
        ...
        @Param('serviceId') serviceId: string,
        @CurrentUser() user: User): Promise<any> {
        return await this._vendorService.getAllLaundryServiceItems(laundryId, serviceId, user)
    }
